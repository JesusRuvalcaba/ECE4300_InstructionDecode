...
module tb_top_id;
    ...
    initial begin
        $dumpfile("tb_top_id.vcd");
        $dumpvars(0, tb_top_id);
    end


    // MIPS Instruction Converter https://mips-converter.jeffsieu.com/
    initial begin
        // initialize all TB-driven inputs
        
        rst_tb = 1'b1;
        wb_reg_write_tb = 1'b0;
        ...
        rst_tb = 0;
        #2  // reset disabled, reg_write disabled, decode RFORMAT
